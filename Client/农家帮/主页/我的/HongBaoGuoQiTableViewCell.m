...
@implementation HongBaoGuoQiTableViewCell
...
- (void)jiazaiCicong
{
    ...
    _timeNumberLable.textColor = BaseColor(255, 255, 255, 1);
    ...
    [_senderButton setBackgroundImage:[UIImage imageNamed:@"zjhh_btn_yiguoqi_fasonghaoyou.png"] forState:UIControlStateNormal];
    [_senderButton setTitleColor:BaseColor(122, 122, 122, 1) forState:UIControlStateNormal];
