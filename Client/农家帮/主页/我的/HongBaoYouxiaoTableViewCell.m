...
@implementation HongBaoYouxiaoTableViewCell
{
...
- (void)jiazaiCicong
{
    ...
    _zhuangtaiImageView.image = [UIImage imageNamed:@"zjhh_ico_tuzhang_weishiyong.png"];
...
//    _goodsMessageLable.attributedText = [[NSString stringWithFormat:@"<red><bold>¥%@</bold>/%@</red><gray>｜%@：%@</gray>", model.price, model.unit, NSLocalizedString(@"运费", @""), model.freight] attributedStringWithStyleBook:style1];
    ...
    _nameNumberLable.textColor = BaseColor(255, 255, 255, 1);
