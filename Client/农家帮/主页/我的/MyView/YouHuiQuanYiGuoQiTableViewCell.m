//
//  YouHuiQuanYiGuoQiTableViewCell.m
//  农家帮
//
...
@implementation YouHuiQuanYiGuoQiTableViewCell
{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        imageView.image = [UIImage imageNamed:@"zjhb_ico_youhuijuan_yiguoqi.jpg"];
        ...
        zhangImageView.image = [UIImage imageNamed:@"zjhh_ico_tuzhang_yiguoqi.png"];
        ...
        _youhuijia.textColor = BaseColor(255, 104, 104, 1);
