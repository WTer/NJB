//
//  YouHuiQuanYiShiYongTableViewCell.m
//  农家帮
//
...
@implementation YouHuiQuanYiShiYongTableViewCell
{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        imageView.image = [UIImage imageNamed:@"zjhb_ico_youhuijuan_yishiyong.jpg"];
        ...
        zhangImageView.image = [UIImage imageNamed:@"zjhh_ico_tuzhang_yishiyong.png"];
        ...
        _youhuijia.textColor = BaseColor(255, 172, 43, 1);
