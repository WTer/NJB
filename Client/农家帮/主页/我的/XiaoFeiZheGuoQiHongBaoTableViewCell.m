//
//  XiaoFeiZheGuoQiHongBaoTableViewCell.m
//  农家帮
//
...
@implementation XiaoFeiZheGuoQiHongBaoTableViewCell
...
- (void)reSetKongjianWeizhi
{
    ...
    _imageView.image = [UIImage imageNamed:@"zjhb_ico_yiguoqi.jpg"];
...
- (void)DingyiCicun
{
    ...
    _imageView.image = [UIImage imageNamed:@"zjhb_ico_(close)yiguoqi.jpg"];
