...
@implementation consumerOrderTableViewCell
...
- (void)DTsetyueshu
{
    ...
    [_orderMessageLable mas_remakeConstraints:^(MASConstraintMaker *make) {
        CGSize size = [_orderMessageLable.text sizeWithFont:[UIFont systemFontOfSize:16.0] maxSize:CGSizeMake(999, 24 * scaleHeight)];
    ...
    [_timeLable mas_remakeConstraints:^(MASConstraintMaker *make) {
        CGSize size = [_timeLable.text sizeWithFont:[UIFont systemFontOfSize:14.0] maxSize:CGSizeMake(999, 24 * scaleHeight)];
    ...
    BaseLableSet(_GoodsNameLable, 52, 52, 52, 21.0);
    ...
    _imageView.image = [UIImage imageNamed:@"grzx_wddd_radio_nor.png"];
    
    
    [_querenlable mas_remakeConstraints:^(MASConstraintMaker *make) {
        CGSize size = [@"取消订单" sizeWithFont:BaseFont(18) maxSize:CGSizeMake(999, 24)];
        make.right.mas_equalTo(-40 * scaleWidth);
        make.width.mas_equalTo(size.width);
        make.centerY.mas_equalTo(_certainOrder.mas_centerY);
        make.height.mas_equalTo(80 * scaleHeight);
    }];
    _querenlable.text = @"取消订单";
    _querenlable.textColor = BaseColor(9, 142, 43, 1);
    _querenlable.font = BaseFont(18.0);
...
- (void)setModel:(myOrderModel *)model
{
    ...
    NSDictionary* style2 = @{@"body":[UIFont systemFontOfSize:16.0],
    ...
    NSDictionary * dict2 = @{@"body":[UIFont systemFontOfSize:16.0],
                             @"gray":@[BaseColor(178, 178, 178, 1),[UIFont systemFontOfSize:16.0]],
    ...
    NSDictionary * dict = @{@"body":[UIFont systemFontOfSize:16.0],
                            @"gray":@[BaseColor(178, 178, 178, 1),[UIFont systemFontOfSize:16.0]],
                            @"black":BaseColor(52, 52, 52, 1)
                            };
